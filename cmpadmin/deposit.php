...
<?php
	/*$t = $mysqli->query("SELECT * FROM bcpp ");
	...
	$type=$_GET['type'];
	$page=$_GET['page'];
	if((!$limit)  || (is_numeric($limit) == false) || ($limit < 19) || ($limit > 21))
	{$limit = 20; }
	...
	$q = $mysqli->query("SELECT * FROM bcpp ORDER BY bcpp_sn DESC LIMIT $set_limit, $limit");
...
?>
									...
									<tbody>
										<tr>
											<td><?php echo $querygetexeres->bcpp_sn; ?></td>
											<td><?php echo $querygetexeres->date; ?></td>  
											<td><?php echo $querygetexeres->status; ?></td>
											<td><?php echo $querygetexeres->user_id; ?></td>  
											<td><?php echo $querygetexeres->refer_id; ?></td>
										</tr>
									</tbody>
<?php //} ?>
													</table>
	...
	<form method="get" action="" style="text-align: center;">
		...
		<input type="submit"  value="Submit" /> 
								...
								<div class="col-xs-6">
									<div class="panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-bar-chart-o fa-fw"></i> Payment Delivery System
											<div class="pull-right"> </div>
										</div>
										<!-- /.panel-heading -->
										<div class="panel-body">
								...
								<table class="table table-bordered table-hover table-striped">
									<thead>
										...
										<tr>
											<th>Transfer:</th>       
											<th>$ <?php echo $row['transfer_taka']; ?></th>
										</tr>
										<tr>
											<th>Withdraw:</th>       
											<th>$ <?php echo $row['withdrow_taka']; ?></th>
										</tr>
									</thead>
								</table>
												</div>
