                            ...
                            <div class="row">
									<div class="panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-bar-chart-o fa-fw"></i> Total Stupid Member Summary
										...
										<div class="panel-body">
											...
											<div class="row">
												<div class="col-sm-3">
													<?php
														$total_member=mysqli_num_rows($mysqli->query("SELECT `user` FROM `stupid_user`"));
													?>
													<button type="button" class="btn btn-info">Total Stupid Member (<?php echo $total_member; ?>)</button>
												</div>
...
<?php
	$t =  $mysqli->query("SELECT * FROM stupid_user ");
	...
	$q =  $mysqli->query("SELECT * FROM stupid_user ORDER BY serial DESC LIMIT $set_limit, $limit");
	$I=1;
	...
	while($querygetexeres= mysqli_fetch_object($q))	
   {
	   ...
	   $mghh43=mysqli_fetch_assoc($mysqli->query("SELECT * FROM `balance` WHERE `user`='".$querygetexeres->user."'"));
...
?>
															<tbody>
																<tr>
																	...
																	<td><?php echo  $mghh43['final_taka']; ?></td>
																	<td><?php echo  gameDepositCalc($querygetexeres->user); ?></td>
																	<td><?php echo  $querygetexeres->played_game; ?></td>
																	<td><?php echo  $querygetexeres->last_renew; ?></td>
																</tr>
<?php } ?>
															</tbody>
														</table>
