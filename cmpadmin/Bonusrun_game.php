    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
				...
				<?php
					$t = $board_game->query("SELECT * FROM `games` WHERE `active`='1' ");
					...
					$q = $board_game->query("SELECT * FROM `games` WHERE `active`='1' ORDER BY serial DESC LIMIT $set_limit, $limit");
														...
														<tr>
															...
															<td style="min-width: 400px;"><?php 
																...
																for($i=0;$i<=$coum;$i++){
																	...
																	echo "<a class='btn btn-info' href='game_details.php?game=". base64_encode($crite[$i]) ."&serd=".base64_encode($querygetexeres->serial)."&cond=".base64_encode("board_game")."'> ". $crite[$i] . " ( ". $totalIInvest['total'] ." ) </a> &nbsp;&nbsp;&nbsp;
