    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<i class="fa fa-bar-chart-o fa-fw"></i> Inactive Games
				...
				<?php
					$t = $multichallenge->query("SELECT * FROM `game_question` WHERE `active`='0' AND `user`='Company' ");
					...
					$q = $multichallenge->query("SELECT * FROM `game_question` WHERE `active`='0' AND `user`='Company'  ORDER BY serial DESC LIMIT $set_limit, $limit");
