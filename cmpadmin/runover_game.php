    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
				...
				<?php
					$t = $mysqli->query("SELECT * FROM `games` WHERE `active`='0' ");
					...
					$q = $mysqli->query("SELECT * FROM `games` WHERE `active`='0' ORDER BY serial DESC LIMIT $set_limit, $limit");
				...
				?>
													<tbody class="del<?php echo $querygetexeres->serial; ?>">
														<tr>
															...
															?></td>
															<td><?php echo $querygetexeres->win_team; ?></td>
															<td>
