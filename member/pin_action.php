    ...
    if(!isset($_SESSION['roboMember'])){
		...
		if(isset($_POST["Format"])){
			...
			<head>
				...
				<title>Capitol Money Pay - Transaction Code Changed</title>
			</head>
			<body style='margin:0; padding:0; font-family: Arial, sans-serif; background-color: #f4f4f4;'>
				<div style='max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 10px; overflow: hidden; box-shadow: 0 4px 10px rgba(0,0,0,0.1);'>
					...
					<div style='background: linear-gradient(135deg, #7C3AED, #A855F7); padding: 30px; text-align: center;'>
						...
						<h1 style='color: #ffffff; margin: 0; font-size: 28px; font-weight: bold;'>Transaction Code Changed</h1>
					...
					<div style='padding: 40px 30px;'>
						...
						<div style='background-color: #F3E8FF; border-left: 4px solid #A855F7; padding: 20px; margin: 20px 0; border-radius: 5px;'>
							<p style='margin: 0; color: #6B21A8; font-size: 16px; font-weight: 500;'>
								✅ <strong>Success!</strong> Your transaction code has been changed successfully.
							</p>
						</div>
						...
						<div style='background-color: #F3F4F6; padding: 20px; border-radius: 8px; margin: 20px 0;'>
							...
							<table style='width: 100%; border-collapse: collapse;'>
								<tr>
									<td style='padding: 8px 0; color: #6B7280; font-weight: 500;'>New Transaction Code:</td>
									<td style='padding: 8px 0; color: #1F2937; font-family: monospace; background: #F9FAFB; padding: 5px; border-radius: 4px;'>$newpass</td>
								</tr>
								<tr>
						...
						<div style='background-color: #FEF3C7; border: 1px solid #F59E0B; padding: 15px; border-radius: 6px; margin: 25px 0;'>
							<p style='margin: 0; color: #92400E; font-size: 14px;'>
								🔒 <strong>Security Tip:</strong> Keep your transaction code confidential and use it for secure transactions only.
							</p>
						</div>
					</div>
			...
			$subject="🔐 Capitol Money Pay - Transaction Code Changed Successfully";
