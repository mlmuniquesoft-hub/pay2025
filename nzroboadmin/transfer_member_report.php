                            ...
                            <div class="row">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-bar-chart-o fa-fw"></i> Send to Member
...
<?php
	...
	$t = $mysqli->query("SELECT * FROM admin_trans_receive where user_transfer='admin' OR user_transfer='superadmin'");
	...
	$q = $mysqli->query("SELECT * FROM admin_trans_receive where user_transfer='admin' OR user_transfer='superadmin' ORDER BY `date` DESC LIMIT $set_limit, $limit");
