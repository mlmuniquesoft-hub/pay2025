                            ...
                            <div class="row">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-bar-chart-o fa-fw"></i>Problem
											...
											<div class="col-lg-12">
												<div class="table-responsive">
													<table class="table table-bordered table-hover table-striped">
														...
														<?php
															$n=1;
															$query=$mysqli->query("SELECT * FROM `problem`");
															while($reqw=mysqli_fetch_assoc($query)){
														?>
														<tr>
															<td><?php echo $n++; ?></td>
															<td><?php echo $reqw['user']; ?></td>
															<td><?php echo $reqw['mail']; ?></td>
															<td><?php echo $reqw['problem']; ?></td>
															<td><?php echo $reqw['date']; ?></td>
															<td><button><a href="dal.php?ser=<?php echo $reqw["id"]; ?>">Delete</a></button></td>
														</tr>
														<?php } ?>
													</table>
