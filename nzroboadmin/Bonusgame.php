    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
                <div class="side-body padding-top">
                    ...
                    <div class="row  no-margin-bottom">
                            ...
                            <div class="row">
								<div class="panel panel-default">
									<div class="panel-heading">
										<i class="fa fa-bar-chart-o fa-fw"></i> Add Bonus Games
										<div class="pull-right"> </div>
									</div>
									<!-- /.panel-heading -->
									<div class="panel-body">
										<div class="row">
											<form class="form-horizontal" id="formElem" name="formElem" action="Bonusgame_action.php" method="post">
												<div class="form-group">
						...
						<div class="col-sm-12">
							<div class="panel panel-default">
								<div class="panel-heading">
									<i class="fa fa-bar-chart-o fa-fw"></i> Upcoming Bonus Games
									<div class="pull-right"> </div>
								</div>
								<!-- /.panel-heading -->
								<div class="panel-body">
				...
				<?php
					$t = $board_game->query("SELECT * FROM `games` WHERE `active`='10' ");
					...
					$q = $board_game->query("SELECT * FROM `games` WHERE `active`='10' ORDER BY serial DESC LIMIT $set_limit, $limit");
														...
														<tr>
															...
															<td style="min-width: 400px;" data-serial="<?php echo $querygetexeres->serial; ?>"><?php 
																...
																for($i=0;$i<=$coum;$i++){
																	...
																	$totalIInvest=mysqli_fetch_assoc($board_game->query("SELECT SUM(amount) as total FROM `play` WHERE `choice`='".$crite[$i]."' AND `gameid`='".$querygetexeres->serial."'"));
																	echo "
			...
			<script>
					var tywew=function(){
						$(".remov2").on("focusout", function(){
							...
							var resd=$.ajax({
								method:"GET",
								url:"remove_ele.php",
								data:{vals:ttqw,cols:ttqw22, serd:serd, werwe:"Add",dts:"board_game"}
							});
					...
					$(".OptionRemove").on("click", function(){
						...
						var resd=$.ajax({
							method:"GET",
							url:"remove_ele.php",
							data:{rets:ttoo, serd:serd, redf:"Remove",dts:"board_game"}
						});
						resd.done(function(reaas){
					...
					$(".ChangeUser").on("click", function(){
						...
						var resd=$.ajax({
							method:"GET",
							url:"remove_ele.php",
							data:{rets:ttoo,cols:cols, serd:serd, cvbd:"Change User",dts:"board_game"}
						});
						resd.done(function(reaas){
							$(".removeOption"+ttoo).hide();
							console.log(reaas);
					...
					$("#game_submit").on("click", function(){
						...
						if(pin!=''){
							if(pin==pin2){
								if(tfg=="Win"){
									var trru="Bonusgame_done.php";
								}else if(tfg=="Cancel"){
									trru="Bonusgame_cancel.php";
								}
								var reqqq=$.ajax({
									method:"GET",
									url: trru,
						...
						$(".uupp").on("keyup", function(){
							...
							if(vals!=''){
								var reqq=$.ajax({
									...
									data:{vas: vals, sers: srl, coll:cols, tbs:"games",dts:"board_game"}
								});
							}
						...
						$(".uopp").on("keyup", function(){
							...
							if(vals!=''){
								var reqq=$.ajax({
									method:"GET",
									url: "info_update_action.php",
									data:{vas: vals, sers: srl, coll:cols, tbs:"games", retur:vals2,dts:"board_game"}
								});
							}
						...
						$(".upgg2").on("click", function(e){
							...
							if(vals!=''){
								var reqq=$.ajax({
									method:"GET",
									url: "info_update_action.php",
									data:{vas: vals, sers: srl, coll:cols, tbs:"games",game:cols2,dts:"board_game"}
								});
