    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
				...
				<?php
					$t = $multichallenge->query("SELECT * FROM `game_question` WHERE `active`='2' AND `user`='Company' ");
					...
					$q = $multichallenge->query("SELECT * FROM `game_question` WHERE `active`='2' AND `user`='Company'  ORDER BY serial DESC LIMIT $set_limit, $limit");
													...
													<tbody class="del<?php echo $querygetexeres->serial; ?>">
														<tr>
															...
															<td style="min-width: 200px;">
																<textarea class="form-control uupp" data-serial="<?php echo $querygetexeres->serial; ?>" data-cols="question" ><?php echo $querygetexeres->question;?> </textarea>
															</td>
															<td>
