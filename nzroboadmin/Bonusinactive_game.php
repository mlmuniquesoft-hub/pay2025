    ...
    <div class="app-container expanded">
		...
		<?php require_once'menu.php'?>
            ...
            <div class="container-fluid">
				...
				<?php
					$t = $board_game->query("SELECT * FROM `games` WHERE `active`>'1' AND `active`<'5'  ");
					...
					$q = $board_game->query("SELECT * FROM `games` WHERE `active`>'1' AND `active`<'5' ORDER BY serial DESC LIMIT $set_limit, $limit");
