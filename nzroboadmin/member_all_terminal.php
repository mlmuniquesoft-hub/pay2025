                            ...
                            <div class="row">
									<div class="panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-bar-chart-o fa-fw"></i> Total Terminal Aceess Member Accounts Summary
										...
										<div class="panel-body">
											<div class="row">
												...
												<div class="col-sm-4">
													<?php
														$total_member=mysqli_num_rows($mysqli3->query("SELECT `user` FROM `terminal_member` "));
													?>
...
<?php
	...
	$t =  $mysqli3->query("SELECT * FROM `terminal_member` ");
	...
	$q =  $mysqli3->query("SELECT * FROM `terminal_member`  ORDER BY serial DESC LIMIT $set_limit, $limit");
	$err = mysqli_num_rows($q);
	$n=1;
	while($querygetexeres= mysqli_fetch_object($q)){
	   $mghh2=mysqli_fetch_assoc($mysqli->query("SELECT * FROM `member` WHERE `user`='".$querygetexeres->user."'"));
	   $mghh=mysqli_fetch_assoc($mysqli->query("SELECT * FROM `profile` WHERE `user`='".$mghh2['log_user']."'"));
?>
															<tbody>
																<tr>
																	<td><?php echo $n++; ?></td>     
																	...
																	<td><?php echo $mghh2['log_user']; ?></td>
																	<td><?php echo $mghh['mobile']; ?></td>
																	<td><?php 
																		$mmnnlk=mysqli_fetch_assoc($mysqli->query("SELECT * FROM `package` WHERE `serial`='".$mghh2['pack']."'"));
																		echo $mmnnlk['pack']; 
																	?></td>
																	<td><?php echo $mghh2['sponsor']; ?></td> 
																	<td><?php echo $mghh2['upline']; ?></td> 
