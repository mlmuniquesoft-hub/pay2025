                            ...
                            <div class="row">
									<div class="panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-bar-chart-o fa-fw"></i> Total Acheivers Member Accounts Summary
										...
										<div class="panel-body">
											<div class="row">
												...
												<div class="col-sm-4">
													<?php
														$total_member=mysqli_num_rows($mysqli->query("SELECT DISTINCT `user` FROM `ranks` "));
													?>
													<button type="button" class="btn btn-info">Total Acheivers (<?php echo $total_member; ?>)</button>
												</div>
											</div>
														...
														<table class="table table-bordered table-hover table-striped">
															<thead>
																<tr>
																	<th>SN:</th>       
																	<th>Rank:</th>
																	<th>Total Acheiver:</th>
																</tr>
															</thead>
<?php
	
	$t =  $mysqli->query("SELECT DISTINCT `rank` FROM `ranks` ");
	...
	$N=1;
	$q =  $mysqli->query("SELECT DISTINCT `rank` FROM `ranks` ");
...
?>
															<tbody>
																<tr>
																	<td><?php echo $N++; ?></td>     
																	<td><a class="btn btn-success" href="member_acheive_list.php?user=<?php echo $querygetexeres->rank; ?>" id="color"><?php echo $querygetexeres->rank; ?></a></td> 
																	<td><?php 
																		$mmnnlk=mysqli_num_rows($mysqli->query("SELECT `user` FROM `ranks` WHERE `rank`='".$querygetexeres->rank."' "));
																		echo $mmnnlk; 
																	?></td>
																</tr>
<?php } ?>
