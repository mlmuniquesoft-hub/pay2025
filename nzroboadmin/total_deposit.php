...
?>
															<tbody>
																<tr>
																	...
																	<td><?php 
																		$ggg=mysqli_fetch_assoc($mysqli->query("SELECT SUM(slot) AS ff FROM `play` WHERE `gameid`='".$querygetexeres->serial."' AND `draw`='".$querygetexeres->team_a."'"));
																		echo $ggg['ff'];
																		
																	?></td> 
																	<td><?php
																		$ggg=mysqli_fetch_assoc($mysqli->query("SELECT SUM(slot) AS ff2 FROM `play` WHERE `gameid`='".$querygetexeres->serial."' AND `draw`='".$querygetexeres->team_b."'"));
																		echo $ggg['ff2'];
																	?></td>
