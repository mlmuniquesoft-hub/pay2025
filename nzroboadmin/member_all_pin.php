                            ...
                            <div class="row">
									<div class="panel panel-default">
										<div class="panel-heading">
											<i class="fa fa-bar-chart-o fa-fw"></i> Total Pin Aceess Member Accounts Summary
										...
										<div class="panel-body">
											<div class="row">
												...
												<div class="col-sm-4">
													<?php
														$total_member=mysqli_num_rows($mysqli->query("SELECT `user` FROM `member` WHERE `node`='1' "));
													?>
...
<?php
	...
	$t =  $mysqli->query("SELECT * FROM `member` WHERE `node`='1' ");
	...
	$q =  $mysqli->query("SELECT * FROM `member` WHERE `node`='1' ORDER BY serial DESC LIMIT $set_limit, $limit");
