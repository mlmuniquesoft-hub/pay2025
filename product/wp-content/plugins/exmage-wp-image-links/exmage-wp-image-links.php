...
define( 'EXMAGE_WP_IMAGE_LINKS_VERSION', '1.0.9' );
					...
					if ( $to_external ) {
						...
						if ( $to_url ) {
							...
							if ( $image_size !== false ) {
								...
								if ( ! is_wp_error( $request ) && wp_remote_retrieve_response_code( $request ) === 200 && in_array( wp_remote_retrieve_header( $request, 'content-type' ), array(
										'image/png',
										'image/jpeg',
										'image/jpg',
										'image/gif',
