                                ...
                                <form class="vi-wbe-settings-tab ">
									...
									$this->setting_input_element( [
										...
										'options' => [
											...
											'regular_price' => esc_html__( 'Regular price', 'bulky-bulk-edit-products-for-woo' ),
											'sale_price'    => esc_html__( 'Sale price', 'bulky-bulk-edit-products-for-woo' ),
									...
									$this->setting_input_element( [
										...
										'min'   => 0,
										'max'   => 1000,
										'label' => esc_html__( 'Time to save revision', 'bulky-bulk-edit-products-for-woo' ),
										'unit'  => esc_html__( 'second(s)', 'bulky-bulk-edit-products-for-woo' ),
									] );
