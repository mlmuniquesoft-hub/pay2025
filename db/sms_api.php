<?php
	...
	function SendSMS($Sender_Name,$Destination_Number, $SMS_Text){
			//Call The Constructor.
		$obj = new Sender("121.241.242.114","","99so-hafiz","123456",$Sender_Name,$SMS_Text,$Destination_Number,"0","1");
		$str_return=$obj->Submit();
		$str_return=substr($str_return,0,4);
		return $str_return;
	}
?>