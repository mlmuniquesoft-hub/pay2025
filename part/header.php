...
<!-- Mirrored from themeim.com/demo/cryptotrade/cryptotrade/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 03 Aug 2019 12:56:41 GMT -->
<head>
	<!-- Required meta tags -->
	<meta charset="utf-8">
	...
	<header>
		...
		<nav id="navigation" class="navbar navbar-expand-lg navbar-dark">
			<div class="container">
				...
				<div class="out-link d-none d-lg-inline"><a href="/login/" class="btn-1">Sign Up</a></div>
				<div class="out-link d-none d-lg-inline"><a href="/login/login.html" class="btn-1">Login</a></div>
